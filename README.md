# SETUP
Git clone the project from github using link: https://github.com/Mosima/stackoverflow.git <br />
git clone https://github.com/Mosima/stackoverflow.git <br />
cd into stackoverflow folder <br />
run npm i <br />
start the project by running npm start <br /><br /><br />

The project wiil open default browser to this link http://localhost:3000/free/dashboard/default <br />
The project use MANTIS template see the credits on the bottom of this file: https://github.com/ codedthemes/mantis-free-react-admin-template <br />
I have used a template to fast work the project since I was attending my cousin's wedding over the weekend. <br /><br />

# Usage <br />
By default users will be all follwed <br />
Click the Avatar of the active user table to view profile on the side <br />
Expand the arrow for a user to view "Block Button", when clicked the user will move to Inactive table
You can perform search <br />
Expand the arrow for a user to view "Follow Button", when clicked the user will move to active table<br /><br />
...
Material UI for theme<br />
JS<br />
React 18<br />

# Folders to check on <br />
 src/pages/dashboard<br />
 src/pages/store<br /><br />

# proposed functionality from me, to be implemented<br />
Using the dashboard stats:<br />
    for displaying top 3 users with high reputation<br />
    How many blocked and followed users<br />
